export const apiURL = {
  ...
  ORDER_PLACED: '/user/place_order/',
  ORDER_SUMMARY: 'user/order_summary/',
  ORDERS: 'owner/orders/',
  ACCEPT_ORDERS: '/owner/orders/accept/',
  REJECT_ORDERS: '/owner/orders/reject/',
  CREATE_ORDER: '/user/create_order/',
  CONFIRM_ORDER: '/user/confirm_payment/',

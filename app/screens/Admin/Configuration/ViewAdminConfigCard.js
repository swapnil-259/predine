...
const ViewAdminConfigCard = ({ visibleModal, hideModal, control, errors, handleSubmit, onSubmit, isValid, parentData, getValues, childData }) => {
...
export default ViewAdminConfigCard;